...
if (message.content === '*help') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
      .addField("** مبرمج البوت :wrench: **","**Zezo**")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
if (message.content === '.invite') {
      message.author.send('https://discordapp.com/api/oauth2/authorize?client_id=491122351098953728&permissions=8&scope=bot|  تفضل ربط البوت     ').catch(e => console.log(e.stack));
